...
const PLANS = [
  {
    code: "open", name: "Open", monthly: 0, annual: 0, cta: "Get started free", ctaHref: "/signup",
    features: ["1 connector (CSV or Plaid)", "1,000 transforms/month", "7-day audit log", "Schema v1.0.0 access", "Community support"],
  },
  {
    code: "build", name: "Build", monthly: 199, annual: 149, cta: "Start Build", ctaHref: "/signup?plan=build",
  ...
  {
    code: "scale", name: "Scale", monthly: 799, annual: 599, popular: true, cta: "Start Scale", ctaHref: "/signup?plan=scale",
  ...
  {
    code: "enterprise", name: "Enterprise", monthly: null, annual: null, cta: "Contact us", ctaHref: "mailto:malik@claremesh.com?subject=ClareMesh%20Enterprise",
